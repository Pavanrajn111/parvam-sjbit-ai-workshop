...
def generate_student_id():
    """
    Generate a unique student ID with format: SJB-xxx-HHMMSS
    Where xxx is the sequential number (3 digits) and HHMMSS is the current timestamp
    """
    db = get_db()
    ...
    return f"SJB-{next_id:03d}-{timestamp}"
